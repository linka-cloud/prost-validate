...
pub static CASES: Lazy<HashMap<&'static str, Factory>> = Lazy::new(|| {
    HashMap::from([
        ...
        (
            ...
            Box::new(|| {
                (
                    Box::new(RepeatedEmbedNone { val: vec![] }) as Box<dyn Validator>,
                    0,
                )
            }) as Factory,
        ),
        ...
        (
            ...
            Box::new(|| {
                (
                    Box::new(RepeatedEmbedCrossPackageNone { val: vec![] }) as Box<dyn Validator>,
                    0,
                )
            }) as Factory,
        ),
        ...
        (
            ...
            Box::new(|| {
                (
                    Box::new(RepeatedMinMax { val: vec![] }) as Box<dyn Validator>,
                    1,
                )
            }) as Factory,
        ),
        ...
        (
            ...
            Box::new(|| {
                (
                    Box::new(RepeatedItemRule { val: vec![] }) as Box<dyn Validator>,
                    0,
                )
            }) as Factory,
        ),
        ...
        (
            ...
            Box::new(|| {
                (
                    Box::new(RepeatedExactIgnore { val: vec![] }) as Box<dyn Validator>,
                    0,
                )
            }) as Factory,
        ),
