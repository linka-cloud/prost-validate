use crate::proto_pbjson::cases;
use crate::proto_pbjson::cases::message_required_oneof::One;
use crate::proto_pbjson::cases::*;
use crate::{now, Factory, Validator};
...
pub static CASES: Lazy<HashMap<&'static str, Factory>> = Lazy::new(|| {
    HashMap::from([
        ...
        (
            ...
            Box::new(|| {
                (
                    Box::new(WrapperFloat {
                        val: Some(FloatValue { value: 1. }),
                    }) as Box<dyn Validator>,
                    0,
                )
            }) as Factory,
        ...
        (
            ...
            Box::new(|| {
                (
                    Box::new(WrapperDouble {
                        val: Some(DoubleValue { value: 1. }),
                    }) as Box<dyn Validator>,
                    0,
                )
            }) as Factory,
        ...
        (
            ...
            Box::new(|| {
                (
                    Box::new(WrapperInt64 {
                        val: Some(Int64Value { value: 1 }),
                    }) as Box<dyn Validator>,
                    0,
                )
            }) as Factory,
        ...
        (
            ...
            Box::new(|| {
                (
                    Box::new(WrapperInt32 {
                        val: Some(Int32Value { value: 1 }),
                    }) as Box<dyn Validator>,
                    0,
                )
            }) as Factory,
        ...
        (
            ...
            Box::new(|| {
                (
                    Box::new(WrapperUInt64 {
                        val: Some(UInt64Value { value: 1 }),
                    }) as Box<dyn Validator>,
                    0,
                )
            }) as Factory,
        ...
        (
            ...
            Box::new(|| {
                (
                    Box::new(WrapperUInt32 {
                        val: Some(UInt32Value { value: 1 }),
                    }) as Box<dyn Validator>,
                    0,
                )
            }) as Factory,
        ...
        (
            ...
            Box::new(|| {
                (
                    Box::new(WrapperBool {
                        val: Some(BoolValue { value: false }),
                    }) as Box<dyn Validator>,
                    1,
                )
            }) as Factory,
            ...
            Box::new(|| {
                (
                    Box::new(WrapperOptionalUuidString {
                        val: Some(StringValue {
                            value: "8b72987b-024a-43b3-b4cf-647a1f925c5d".to_string(),
                        }),
                    }) as Box<dyn Validator>,
                    0,
                )
                ...
                (
                    Box::new(KitchenSinkMessage {
                        val: Some(ComplexTestMsg {
                            ...
                            int_const: 5,
                            bool_const: false,
                            float_val: Some(FloatValue { value: 1. }),
            ...
            Box::new(|| {
                (
                    Box::new(KitchenSinkMessage {
                        val: Some(ComplexTestMsg {
                            bool_const: true,
                            float_val: Some(FloatValue { value: 0. }),
