...
mod int64 {
    ...
    test_case!(
        ...
        Int64LteOptional { val: Some(63) },
        0
    );
    test_case!(
        int64_optional_lte_valid_equal,
        Int64LteOptional { val: Some(64) },
        0
    );
    test_case!(
        int64_optional_lte_valid_unset,
        Int64LteOptional { val: None },
        0
    );
}
#[cfg(test)]
...
mod bytes {
    ...
    test_case!(
        bytes_ip_valid_v6,
        BytesIp {
            val: b"\x20\x01\x0D\xB8\x85\xA3\x00\x00\x00\x00\x8A\x2E\x03\x70\x73\x34".to_vec()
        },
        0
    );
    test_case!(
...
mod r#enum {
    ...
    test_case!(
        ...
        EnumAliasDefined { val: 1 },
        0
    );
    test_case!(
        enum_alias_defined_only_invalid,
        EnumAliasDefined { val: i32::MAX },
        1
    );
...
mod message {
    ...
    test_case!(
        ...
        MessageRequiredButOptional::default(),
        0
    );
}
#[cfg(test)]
mod repeated {
    ...
    test_case!(
        ...
        RepeatedEmbedNone::default(),
        0
    );
    test_case!(
        repeated_embed_none_valid_empty,
        RepeatedEmbedNone { val: vec![] },
        0
    );
    test_case!(
    ...
    test_case!(
        ...
        RepeatedEmbedCrossPackageNone::default(),
        0
    );
    test_case!(
        repeated_cross_package_embed_none_valid_empty,
        RepeatedEmbedCrossPackageNone { val: vec![] },
        0
    );
    test_case!(
    ...
    test_case!(
        ...
        RepeatedMinMax { val: vec![1, 2, 3] },
        0
    );
    test_case!(
        repeated_min_max_valid_min,
        RepeatedMinMax { val: vec![1, 2] },
        0
    );
    test_case!(
    ...
    test_case!(
        ...
        RepeatedExact { val: vec![1, 2, 3] },
        0
    );
    test_case!(
        repeated_exact_invalid_below,
        RepeatedExact { val: vec![1, 2] },
        1
    );
    test_case!(
    ...
    test_case!(
        ...
        RepeatedMinAndMaxItemLen::default(),
        1
    );
    test_case!(
...
mod wrapper {
    ...
    test_case!(
        ...
        WrapperRequiredEmptyString::default(),
        1
    );
    ...
    test_case!(
        ...
        WrapperOptionalUuidString::default(),
        0
    );
    test_case!(
    ...
    test_case!(
        ...
        WrapperRequiredFloat { val: Some(1.) },
        0
    );
    test_case!(
        wrapper_required_float_invalid,
        WrapperRequiredFloat { val: Some(-5.) },
        1
    );
    test_case!(
        wrapper_required_float_invalid_empty,
        WrapperRequiredFloat::default(),
        1
    );
}
#[cfg(test)]
